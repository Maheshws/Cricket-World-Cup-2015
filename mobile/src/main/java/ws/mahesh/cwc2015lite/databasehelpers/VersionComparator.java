package ws.mahesh.cwc2015lite.databasehelpers;
...
class VersionComparator implements Comparator<String> {
     ...
     * @throws ws.mahesh.cwc2015lite.databasehelpers.SQLiteAssetHelper.SQLiteAssetException thrown if the strings are not in the correct upgrade
     *                                                                                      script format of:
